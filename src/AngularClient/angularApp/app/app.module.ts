...
export class AppModule {
    constructor(public oidcSecurityService: OidcSecurityService) {
        ...
        openIDImplicitFlowConfiguration.stsServer = 'https://rp.certification.openid.net:8080/angular-auth-oidc-client.config/rp-discovery-jwks_uri-keys';
        ...
        openIDImplicitFlowConfiguration.client_id = '3SKcA8rnyTQm';
